...
export const faqItems = [
  {
    ...
    answer: "はい。Re:Talkは無料で利用できます。",
  },
  {
    question: "iPhone / iPadで使えますか？",
    answer: "iPhoneとiPadに対応しています。正式な対応OSはApp Store公開時の案内をご確認ください。",
  },
  {
    question: "どんな訓練がありますか？",
    answer: "6つの訓練カテゴリに、29の訓練課題を用意しています。課題によって選べる設定は異なります。",
  },
  {
    question: "医療機関や介護施設でも使えますか？",
    answer: "自主訓練の支援や、訓練・評価・リハビリ記録の振り返りに活用できます。施設での運用は各施設の方針に沿ってご検討ください。",
  },
  {
  ...
  },
  {
    ...
    answer: "患者さんの情報をできるだけ端末内で扱う設計を基本にしています。詳細は公開時の安全性・プライバシー情報をご確認ください。",
  },
  {
  ...
  },
  {
    ...
    answer: "お問い合わせページからご連絡いただける窓口を公開時に案内します。",
  },
] as const;
